<div align="center">
  ...
  **Verarbeitet und digitalisiert Personalfrageboegen fuer neue Mitarbeiter**
...
Verarbeitet und digitalisiert Personalfrageboegen fuer neue Mitarbeiter. Verwenden für: Eingabe von Stammdaten (Name, Adresse, Bankverbindung), Dokumenten-Upload, IBAN-Validierung, PDF-Generierung.
...
```
/ff-hr-einstellung
"Mit Ff Hr Einstellung erstellen"
```
...
```
--no-ff-hr-einstellung
--skip-ff-hr-einstellung
"ohne Ff Hr Einstellung"
```
