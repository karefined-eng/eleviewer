<div align="center">
  ...
  **Verarbeitet und dokumentiert Schadensmeldungen digital**
...
Verarbeitet und dokumentiert Schadensmeldungen digital. Verwenden für: Eingabe von Schadensdaten (Objektadresse, Schadensart), Foto-Upload zur Dokumentation, automatische Benachrichtigung des Projektleiters.
...
```
/ff-schadensmeldung
"Mit Ff Schadensmeldung erstellen"
```
...
```
--no-ff-schadensmeldung
--skip-ff-schadensmeldung
"ohne Ff Schadensmeldung"
```
