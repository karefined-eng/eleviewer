...
WelcomeLabel2=This will install EleViewer on your computer.%n%nEleViewer is a lightweight, offline study workspace that opens PDFs, Word documents, Excel spreadsheets, PowerPoint slides, Markdown notes, and moreΓÇöall in one place without lag or telemetry.%n%nClick Next to continue.
...
[Files]
; Standalone Nuitka build ΓÇö copy entire dist folder (includes Qt/WebEngine DLLs)
...
; Context Menu (Right-Click "Open with EleViewer") ΓÇö Per-User
